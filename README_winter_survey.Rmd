...
4. Definitions: These are files used for reading the biotic xlm-data. Download them from https://github.com/jofall/Cruisenotebook and place in folder "Definitions".
