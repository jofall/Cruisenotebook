...
5. Definitions: These is a file used for reading the biotic xlm-data. Download it from https://github.com/jofall/Cruisenotebook and place in folder "Definitions".
